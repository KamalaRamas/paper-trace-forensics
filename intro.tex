...
\ash{Distributed tracing systems like Dapper, do uniform sampling at very low rates to keep the cost of storing traces low. 
...
Individual services have always been augmented with logging, telemetry but they alone cannot reconstruct the elaborate journey of a request across any distributed system. 
Initially distributed tracing was confined to microservices. 
There has been a proliferation of tracing into components like databases, queues, proxies, cache \cite{OpenTracingCassandra, OpenTracingKafka, OpenTracingRedis}. 
This has lead to complete end to end tracing in distributed systems. 
